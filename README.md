# This all started witha plain dumb Excel sheet where we were adding data abount new sales requests for my Company. So I improvised and moced it to Google Spreadsheet,
